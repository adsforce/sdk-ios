...
+ (NSString *)getNetworkStatus {
    ...
    if ([[AdsforceNetConnectionManager sharedInstance] isWifiConneted]) {
        str = @"1";
    }
    else {
...
+ (NSString *)deviceId {
    NSString *str = [AdsforceStatisticalKeychainDeviceID deviceID];
    return str;
}
...
+ (NSArray <NSString *> *)randamArry:(NSArray <NSString *> *)arry {
    ...
    NSArray *randamArry = [arry sortedArrayUsingComparator:^NSComparisonResult(NSString *str1, NSString *str2) {
